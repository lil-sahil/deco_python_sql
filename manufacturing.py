...
# s = Sql('172.19.11.38','DE-FcDbExporter')

# df = s.table_to_df('machine_performances')

# print(df)

# s.OEE(df,['2021-01-01','2021-01-08'],'CD6 Line 1', 2)

# print(Failure_analysis())

#_____

# a  = Failure_analysis('HYD2 Press 2', r'\bcheck\s?valve')
# print(a.get_failure_data())
