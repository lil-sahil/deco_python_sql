...
def get_station_from_comment(comment):
  if comment is None:
    ...
    pattern = re.compile(r'(^\d*|\d*[/-]\d*|\bop|\bstn|\bst|\bstation|\br|\bmh|\bzone)(\s|-|#|\d)(\s|-|#)?\s?\d*')
...
df_filtered.to_csv(r'T:\ASSEMBLY\Bo\data.csv')

# df_filtered.to_csv(r'C:\Users\sahil.nagpal\OneDrive - Magna\Desktop\Academia\Python\Deco Projects\Weld Assembly Dashboard\Code\data.csv')
